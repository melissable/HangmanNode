...
var hangman = {
  ...
  startGame: function() {
    ...
    inquirer.prompt([{
      ...
      if(answer.play){
        ...
        console.log("I'm sad you don't want to play.. :( ");
      }
    })},
  ...
  keepPromptingUser : function(){
    ...
    inquirer.prompt([{
      name: "chosenLtr",
      type: "input",
      message: "Choose your letter guess:",
      ...
      var guessedAlready = false;
        ...
        if(guessedAlready === false){
          ...
          if(found === 0){
            ...
            console.log('Yippee! You guessed correctly!');
              //checks to see if user won
              if(that.currentWord.didWeFindTheWord() === true){
                console.log(that.currentWord.wordRender());
                console.log(`Congratulations! The Gods are in your favor and you've won the game!!!`);
                // that.startGame();
              } else{
          ...
          if(that.guessesRemaining > 0 && that.currentWord.wordFound === false) {
            ...
            console.log('Mt. Olympus has erupted and you have lost the game!');
            console.log('The word you were guessing was: ' + that.currentWord.word);
          }
        } else{
            console.log("You've already guessed that one. Here, try again.")
            that.keepPromptingUser();
          }
    });
  }
